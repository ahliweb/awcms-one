...
<!-- i18n-source-hash: sha256:04c08cce51971b16d2fbcb71e04ee5550f027e68333b8615c4b43fb96c09697c -->
...
### Payment gateway — separuh sesi Midtrans Snap, telah diimplementasikan (#110, kontrak #106/ADR-0017 D3; separuh INTAKE webhook adalah #113)

`PaymentGatewayProvider` (port D3) diimplementasikan oleh adapter Midtrans Snap dan adapter `log` untuk dev/CI, di-resolve dari `COMMERCE_PAYMENT_GATEWAY` — lihat "Gerbang pembayaran" di [`docs/cms.md`](cms.id.md) untuk cerita lengkap disiplin transaksi/idempotensinya.
