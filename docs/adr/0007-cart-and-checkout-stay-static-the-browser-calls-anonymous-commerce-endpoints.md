...
- Customer accounts (#32) will add authenticated endpoints beside these anonymous ones; that will need a session strategy for a cross-origin browser client (`apps/cms`'s own ADR-0050, the BFF handoff pattern, is the starting point) and its own ADR.
