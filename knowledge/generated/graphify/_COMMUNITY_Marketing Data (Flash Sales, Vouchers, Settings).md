...
- [[PopupFrequency]] - code - apps/storefront/src/lib/awcms/pemasaran.ts
- [[PromoSection]] - code - apps/storefront/src/lib/awcms/pemasaran.ts
- [[PromoSectionItem]] - code - apps/storefront/src/lib/awcms/pemasaran.ts
- [[ShippingAlternativeService]] - code - apps/storefront/src/lib/awcms/pemasaran.ts
- [[ShippingSettings]] - code - apps/storefront/src/lib/awcms/pemasaran.ts
- [[Slider]] - code - apps/storefront/src/lib/awcms/pemasaran.ts
- [[StoreFaq]] - code - apps/storefront/src/lib/awcms/pemasaran.ts
- [[StoreFavicon]] - code - apps/storefront/src/lib/awcms/pemasaran.ts
- [[StoreLogo]] - code - apps/storefront/src/lib/awcms/pemasaran.ts
- [[StoreSettings]] - code - apps/storefront/src/lib/awcms/pemasaran.ts
...
```dataview
TABLE source_file, type FROM #community/Marketing_Data_Flash_Sales_Vouchers_Settings
SORT file.name ASC
```

## Connections to other communities
- 15 edges to [[_COMMUNITY_Site Profile & Base Layout]]
- 14 edges to [[_COMMUNITY_Homepage & Derived CSP Artifact]]
- 3 edges to [[_COMMUNITY_Build-Time CMS Client & Region Data]]
- 2 edges to [[_COMMUNITY_Product & Category Pages, Product JSON-LD]]
- 1 edge to [[_COMMUNITY_Catalog Data & Product Index]]

## Top bridge nodes
- [[pemasaran.ts]] - degree 52, connects to 5 communities
