...
## Members
- [[ADR-0003_3]] - concept - apps/storefront/src/lib/keranjang-kontrak.ts
...
```dataview
TABLE source_file, type FROM #community/Cart_Client_Storage
SORT file.name ASC
```

## Connections to other communities
- 14 edges to [[_COMMUNITY_Cart Contract & WhatsApp Fallback]]
- 5 edges to [[_COMMUNITY_Order Session & Phone]]
- 2 edges to [[_COMMUNITY_Product Detail Variant Picker]]
- 1 edge to [[_COMMUNITY_Site Chrome & Navigation]]
