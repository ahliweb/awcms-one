...
```dataview
TABLE source_file, type FROM #community/Blog_Client__Ad_Slots
SORT file.name ASC
```

## Connections to other communities
- 10 edges to [[_COMMUNITY_berita.ts]]
- 5 edges to [[_COMMUNITY_slugfeed.xml.ts]]
...
- 3 edges to [[_COMMUNITY_Legacy Redirect Map & Video Lookup]]
- 3 edges to [[_COMMUNITY_media.ts]]
- 2 edges to [[_COMMUNITY_routes.ts]]
- 1 edge to [[_COMMUNITY_Article Pages & News JSON-LD]]
- 1 edge to [[_COMMUNITY_BjekMart Seed Tool]]

## Top bridge nodes
- [[blog.ts]] - degree 35, connects to 8 communities
