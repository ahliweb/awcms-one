...
- [[ADR-0007_5]] - concept - apps/storefront/tests/e2e/global-setup.ts
...
```dataview
TABLE source_file, type FROM #community/global-setupts
SORT file.name ASC
```
...
## Top bridge nodes
- [[globalSetup()]] - degree 3, connects to 1 community