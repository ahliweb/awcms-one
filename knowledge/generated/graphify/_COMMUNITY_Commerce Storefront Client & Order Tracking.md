...
- [[STATUS_LABELS]] - code - apps/storefront/src/lib/pesanan-render.ts
...
- [[createPesananRenderer()]] - code - apps/storefront/src/lib/pesanan-render.ts
- [[finalizePaymentProofUpload()]] - code - apps/storefront/src/lib/toko-klien.ts
- [[getOrder()]] - code - apps/storefront/src/lib/toko-klien.ts
- [[loadOrder()]] - code - apps/storefront/src/scripts/pesanan.ts
- [[mockFetch()_1]] - code - apps/storefront/tests/toko-klien.test.ts
- [[pesanan-render.ts]] - code - apps/storefront/src/lib/pesanan-render.ts
- [[pesanan-sesi.ts]] - code - apps/storefront/src/lib/pesanan-sesi.ts
- [[readStoredPhone()]] - code - apps/storefront/src/scripts/pesanan.ts
- [[renderOrder()]] - code - apps/storefront/src/scripts/pesanan.ts
- [[root_13]] - code - apps/storefront/src/scripts/pesanan.ts
- [[scriptspesanan.ts]] - code - apps/storefront/src/scripts/pesanan.ts
- [[storePhone()]] - code - apps/storefront/src/scripts/pesanan.ts
...
```dataview
TABLE source_file, type FROM #community/Commerce_Storefront_Client__Order_Tracking
SORT file.name ASC
```

## Connections to other communities
- 9 edges to [[_COMMUNITY_Account API Client]]
- 8 edges to [[_COMMUNITY_Checkout Flow & Phone Preview]]
- 6 edges to [[_COMMUNITY_Cart Page & WhatsApp Fallback]]
- 4 edges to [[_COMMUNITY_Login (OTP) Page Script & Request Plumbing]]
