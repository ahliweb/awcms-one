...
```dataview
TABLE source_file, type FROM #community/kategori/slugastro
SORT file.name ASC
```

## Connections to other communities
- 17 edges to [[_COMMUNITY_catalog.ts]]
- 8 edges to [[_COMMUNITY_productslug.astro]]
- 3 edges to [[_COMMUNITY_routes.ts]]
- 2 edges to [[_COMMUNITY_site.ts]]
- 2 edges to [[_COMMUNITY_produk-detail.ts]]
- 2 edges to [[_COMMUNITY_getProducts]]
- 2 edges to [[_COMMUNITY_produk-listing.ts]]
- 1 edge to [[_COMMUNITY_BaseLayout.astro]]

## Top bridge nodes
- [[kategorislug.astro]] - degree 19, connects to 6 communities
- [[katalog-catalog.test.ts]] - degree 19, connects to 5 communities
- [[jsonld-produk.ts]] - degree 12, connects to 2 communities
- [[CommerceProduct]] - degree 5, connects to 2 communities
