...
```dataview
TABLE source_file, type FROM #community/penyajimjs
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_pemasaran.ts]]
- 4 edges to [[_COMMUNITY_buletin.ts]]
...
- [[penyaji.mjs]] - degree 39, connects to 1 community