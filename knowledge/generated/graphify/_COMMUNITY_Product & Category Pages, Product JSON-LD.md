...
```dataview
TABLE source_file, type FROM #community/Product__Category_Pages_Product_JSON-LD
SORT file.name ASC
```

## Connections to other communities
- 20 edges to [[_COMMUNITY_Catalog Data & Product Index]]
- 5 edges to [[_COMMUNITY_routes.ts]]
- 5 edges to [[_COMMUNITY_Homepage & Derived CSP Artifact]]
- 5 edges to [[_COMMUNITY_Price Formatting & Product Cards]]
...
- 3 edges to [[_COMMUNITY_Product Detail Variants Script]]
- 2 edges to [[_COMMUNITY_Marketing Data (Flash Sales, Vouchers, Settings)]]
