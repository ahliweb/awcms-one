...
- [[adrStatus()]] - `contains` [EXTRACTED]
- [[auditAdrCitations()]] - `contains` [EXTRACTED]
- [[auditAdrIndex()]] - `contains` [EXTRACTED]
- [[auditLinkedCounts()]] - `contains` [EXTRACTED]
- [[auditLinks()]] - `contains` [EXTRACTED]
- [[auditNamedPaths()]] - `contains` [EXTRACTED]
- [[auditOneIndex()]] - `contains` [EXTRACTED]
- [[countTableRows()]] - `contains` [EXTRACTED]
- [[countedBlocksIn()]] - `contains` [EXTRACTED]
