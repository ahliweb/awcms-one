...
## Members
- [[WISHLIST_EVENT_NAME]] - code - apps/storefront/src/lib/wishlist-kontrak.ts
- [[WISHLIST_STORAGE_KEY]] - code - apps/storefront/src/lib/wishlist-kontrak.ts
- [[WISHLIST_SYNC_MAX_ITEMS]] - code - apps/storefront/src/lib/wishlist-sinkron.ts
- [[Wishlist]] - code - apps/storefront/src/lib/wishlist-kontrak.ts
- [[WishlistItem]] - code - apps/storefront/src/lib/wishlist-kontrak.ts
- [[WishlistSinkronItem]] - code - apps/storefront/src/lib/wishlist-sinkron.ts
- [[addWishlistItem()]] - code - apps/storefront/src/lib/wishlist-kontrak.ts
- [[createEmptyWishlist()]] - code - apps/storefront/src/lib/wishlist-kontrak.ts
- [[gabungkanWishlist()]] - code - apps/storefront/src/lib/wishlist-sinkron.ts
...
- [[item()_1]] - code - apps/storefront/tests/wishlist-sinkron.test.ts
...
- [[laporkanKegagalan()]] - code - apps/storefront/src/lib/wishlist-akun-sync.ts
- [[loadWishlist()]] - code - apps/storefront/src/lib/wishlist-klien.ts
- [[parseWishlist()]] - code - apps/storefront/src/lib/wishlist-kontrak.ts
- [[pasangSinkronisasiWishlist()]] - code - apps/storefront/src/lib/wishlist-akun-sync.ts
...
- [[sinkronkanWishlistSaatMasuk()]] - code - apps/storefront/src/lib/wishlist-akun-sync.ts
...
- [[wishlist-klien.ts]] - code - apps/storefront/src/lib/wishlist-klien.ts
...
```dataview
TABLE source_file, type FROM #community/wishlist-akun-syncts
SORT file.name ASC
```
