...
```dataview
TABLE source_file, type FROM #community/awcms/analitikts
SORT file.name ASC
```
...
## Top bridge nodes
- [[AwcmsApiError]] - degree 9, connects to 6 communities
- [[awcmsanalitik.ts]] - degree 14, connects to 2 communities
- [[analitik-terpopuler.test.ts]] - degree 14, connects to 1 community
- [[getTopPaths()]] - degree 4, connects to 1 community
- [[hitungTayangPerSlug()]] - degree 4, connects to 1 community