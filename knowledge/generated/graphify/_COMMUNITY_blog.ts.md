...
- [[beritaindex.astro]] - code - apps/storefront/src/pages/berita/index.astro
...
- [[isExpectedRefusal()_3]] - code - apps/storefront/src/lib/awcms/blog.ts
...
- 6 edges to [[_COMMUNITY_Sidebar.astro]]
...
- 2 edges to [[_COMMUNITY_lembaga.ts]]
- 2 edges to [[_COMMUNITY_n.astro]]
- 1 edge to [[_COMMUNITY_awcmsanalitik.ts]]
- 1 edge to [[_COMMUNITY_BeritaLayout.astro]]
- 1 edge to [[_COMMUNITY_slugfeed.xml.ts]]

## Top bridge nodes
- [[blog.ts]] - degree 34, connects to 7 communities
- [[beritaindex.astro]] - degree 14, connects to 7 communities
- [[IklanSlot.astro]] - degree 8, connects to 2 communities
- [[iklan.ts]] - degree 10, connects to 1 community
