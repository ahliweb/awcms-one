...
| Admin screens                     | **68** `.astro` files in `src/pages/admin/`; **0 of 25** modules without `navigation:` | `find src/pages/admin -name '*.astro'`, `grep -L 'navigation:' src/modules/*/module.ts` |
| `.astro` files                    | **83** (45.888 lines) — on typechecking see §6                                         | `find src -name '*.astro'`                                                              |
