...
| Migrations                        | **184** (`sql/001`–`933`)                                                              | `ls sql/`                                                                               |
| ADR                               | **0000**–**0121** (`0000` = template; highest ADR status: **Accepted**)                | `ls docs/adr/`                                                                          |
| Admin screens                     | **65** `.astro` files in `src/pages/admin/`; **0 of 25** modules without `navigation:` | `find src/pages/admin -name '*.astro'`, `grep -L 'navigation:' src/modules/*/module.ts` |
| `.astro` files                    | **79** (43.249 lines) — on typechecking see §6                                         | `find src -name '*.astro'`                                                              |
