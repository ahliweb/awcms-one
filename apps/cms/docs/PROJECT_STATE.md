...
| Migrations                        | **173** (`sql/001`–`920`)                                                              | `ls sql/`                                                                               |
| ADR                               | **0000**–**0121** (`0000` = template; highest ADR status: **Accepted**)                | `ls docs/adr/`                                                                          |
| Admin screens                     | **60** `.astro` files in `src/pages/admin/`; **0 of 25** modules without `navigation:` | `find src/pages/admin -name '*.astro'`, `grep -L 'navigation:' src/modules/*/module.ts` |
| `.astro` files                    | **74** (40.782 lines) — on typechecking see §6                                         | `find src -name '*.astro'`                                                              |
