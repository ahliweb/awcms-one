...
<!-- i18n-source-hash: sha256:77b1557a716a4a6d435a03591651950dd758d61ccd97240cd93082f7a6139dde -->
...
| Migrasi                            | **181** (`sql/001`–`932`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **77** (42.554 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
