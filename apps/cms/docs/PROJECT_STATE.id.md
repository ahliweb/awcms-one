...
<!-- i18n-source-hash: sha256:0c8b06aee9f64f9228497618aaa8e32af3e95c6442c806680ce64d10eafabeaf -->
...
| Berkas `.astro`                    | **71** (40.114 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
