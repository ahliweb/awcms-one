...
<!-- i18n-source-hash: sha256:0fd075fdac37d37150d5cf540951a0c58e74c428afe66c3fddbdfd2d18aaf03a -->
...
| Migrasi                            | **181** (`sql/001`–`928`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **77** (42.100 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
