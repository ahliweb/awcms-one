...
<!-- i18n-source-hash: sha256:2faa3296c8c7746c6cb9fe169189368c42648f6e68b0d16ff2d240ba2e94f71a -->
...
| Migrasi                            | **178** (`sql/001`–`925`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **76** (41.584 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
