...
<!-- i18n-source-hash: sha256:9e6eac04a5c784982ac455bd89650e345dde793383af7264e2d2f888b6016878 -->
...
| Migrasi                            | **177** (`sql/001`–`925`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **76** (41.457 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
