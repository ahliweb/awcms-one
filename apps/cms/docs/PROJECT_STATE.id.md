...
<!-- i18n-source-hash: sha256:ccc6da23dd702367088dc40bcc0c269acc8d19098375e5e6d60f852179066c7b -->
...
| Migrasi                            | **184** (`sql/001`–`933`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **79** (43.249 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
