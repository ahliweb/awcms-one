...
<!-- i18n-source-hash: sha256:62f0634e9f481513618b9b8afc95732218c2a61fe37c5091c9dc2f7efc34545c -->
...
| Migrasi                            | **177** (`sql/001`–`924`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **75** (41.426 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
