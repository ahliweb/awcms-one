...
<!-- i18n-source-hash: sha256:5138c7e6aa11825cfa2cbefa8c2efda15814fc23e0ccaadc0c1b331e1901fdb1 -->
...
| Migrasi                            | **180** (`sql/001`–`928`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **77** (41.920 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
