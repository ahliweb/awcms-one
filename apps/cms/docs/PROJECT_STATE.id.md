...
<!-- i18n-source-hash: sha256:d031dacf912765ffe85f1ed1074b73428f661444e53b19898653ef5307a2ea2f -->
...
| Migrasi                            | **184** (`sql/001`–`934`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **78** (42.782 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
