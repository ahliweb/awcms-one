...
<!-- i18n-source-hash: sha256:74ce83988517360198c8885965cae3507730f4a5299b5faeb6eccbe5cffe2548 -->
...
| Migrasi                            | **183** (`sql/001`–`930`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **78** (42.555 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
