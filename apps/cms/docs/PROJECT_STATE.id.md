...
<!-- i18n-source-hash: sha256:83ae28ef4f780b61757b2022522ce533a7c42dc50b3abbfa1bbad2e5b02ae53d -->
...
| Migrasi                            | **179** (`sql/001`–`928`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **77** (41.793 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
