...
<!-- i18n-source-hash: sha256:da9315864af0e0ff955b324f0ea8d3a9a5bfc6684f71380471b717b3eade68cf -->
...
| Migrasi                            | **180** (`sql/001`–`934`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **76** (41.991 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
