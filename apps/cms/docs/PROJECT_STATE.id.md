...
<!-- i18n-source-hash: sha256:7a62886fbf57b573e7b0fcae9519648bbca3566b05fca22a8d9395c497ba6023 -->
...
| Migrasi                            | **179** (`sql/001`–`926`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **76** (41.764 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
