...
<!-- i18n-source-hash: sha256:f3d4b14a236107c3b181c9b0502bdba40410bc6034a93c0e899d5f0b6b774fdc -->
...
| Migrasi                            | **182** (`sql/001`–`930`)                                                             | `ls sql/`                                                                               |
...
| Berkas `.astro`                    | **78** (42.375 baris) — soal typecheck lihat §6                                       | `find src -name '*.astro'`                                                              |
