...
<!-- i18n-source-hash: sha256:00bf1906b0d0783248e1cb815bdbcc0bd0ebd3380b75c4b697894a8f8b3af7a3 -->
...
## Provider eksternal — kontrak saja, kecuali D4, D5 dan D8 (epic #33 wave 0 — ADR-0017, issue #106)
...
yang ditampung `reporting` (D7), kampanye bergerbang consent (D9), dan flag pengaturan
modul plus harga bertingkat saat quote (D10). **D4 (tarif kurir), D5
(WhatsApp) dan D8 (kotak masuk) adalah tiga pengecualiannya — semuanya
sudah DIIMPLEMENTASIKAN, bukan kontrak-saja; lihat bagian masing-masing di
bawah.** Setiap satu dari sepuluh keputusan D1–D10 — mengapa port
...
akun. Entri pengecualian milik tarif kurir, WhatsApp, dan kotak masuk sendiri
sudah dihapus (#107, #108, #111). ADR-0017 menamai setiap variabel lingkungan baru
