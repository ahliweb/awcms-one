...
<!-- i18n-source-hash: sha256:87fd75c5c7f38fb62b39746e494bbe2b916d9ddd9894d9762ee2110cc8b26b80 -->
...
## Provider eksternal — kontrak saja, kecuali D4, D5, D8, dan separuh sesi D2/D3 (epic #33 wave 0 — ADR-0017, issue #106)
...
tiga proyeksi penjualan yang ditampung `reporting` (D7), kampanye
bergerbang consent (D9), dan flag pengaturan modul plus harga bertingkat
saat quote (D10). **D4 (tarif kurir), D5 (WhatsApp), D8 (kotak masuk),
dan separuh sesi D2/D3 (pembuatan sesi payment-gateway + token
webhook-endpoint, Midtrans Snap) sudah DIIMPLEMENTASIKAN, bukan
kontrak-saja; lihat bagian masing-masing di bawah.** Setiap satu dari
...
entri mengutip issue anak yang menghapusnya: POS (#116), laporan
...
separuh sesi payment-gateway sendiri sudah dihapus (#107, #108, #111,
