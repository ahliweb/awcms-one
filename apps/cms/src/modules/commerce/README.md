...
## External providers — contract only, except D4, D5 and D8 (epic #33 wave 0 — ADR-0017, issue #106)
...
projections (D7), consent-gated campaigns (D9), and the module-settings feature flags
plus tiered pricing at quote (D10). **D4 (courier rates), D5
(WhatsApp) and D8 (the inbox) are the three exceptions — all IMPLEMENTED,
not contract-only; see their own sections below.** Every one of
...
tokens (#110), POS (#116), sales reports (#117), and
...
WhatsApp's and the inbox's own exemption entries are already removed
(#107, #108, #111). ADR-0017
